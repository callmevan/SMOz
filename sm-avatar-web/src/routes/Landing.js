          ...
          <div className="landing-container flex-grow-1">
            <div className="col-12 col-lg-6">
              <div className="row" style={{ marginBottom: '9px' }}>
                <div>
                  <h1 className="fw-bol">Meet Digital Human</h1>
                </div>
              </div>
              <div className="row">
                <div>
                  <h4 className="fw-light" style={{ marginBottom: '31px' }}>
                    Personalised health-related A.I. research in partnership with Soul Machines.
                  </h4>
                </div>
              </div>
              ...
              <div className="row" style={{ marginBottom: '60px' }}>
                <div className="col">
                  <Link
                    to="/loading/toku-hoa?userID=demo"
              ...
              <div className="row">
                <div>
                  ...
                  {' '}
                  <a href="https://www.auckland.ac.nz/en/abi.html">ABI</a>
                  .
                </div>
              </div>
              <div className="col" />
